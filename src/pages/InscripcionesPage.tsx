...
export default function InscripcionesPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-marathon-cream px-1 py-3 sm:px-6 sm:py-6 lg:px-8">
      <img
      ...
      <div className="relative mx-auto flex w-full min-w-0 max-w-[1180px] flex-col gap-4 sm:gap-5">
        <RegistrationHero />
        {registrationResult ? (
          <RegistrationSuccess
