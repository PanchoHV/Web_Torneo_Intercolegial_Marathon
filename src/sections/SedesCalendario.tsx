...
// Fondo deportivo premium (R2) - URL proporcionada (espacios permitidos)
const SEDES_BACKGROUND_URL =
  'https://pub-dc06325214ac4e9a8959030cf5f65654.r2.dev/optimized-ChatGPT Image 5 may 2026, 12_07_13 p.webp';
...
export default function SedesCalendario() {
  ...
  return (
    <section
      ...
      style={{ height: 'min(70vh, calc(100vw * 9 / 16))' }}
    >
        ...
        <div
          aria-hidden="true"
            ...
            style={{
              backgroundImage: `url("${SEDES_BACKGROUND_URL}")`,
              backgroundSize: 'contain',
              backgroundPosition: 'center top',
              backgroundRepeat: 'no-repeat',
            }}
        />
        {/* Dark overlay (reducida para dejar ver el fondo) */}
        <div aria-hidden="true" className="absolute inset-0 bg-[#021d34]/60" />
            ...
            export default function SedesCalendario() {
              ...
              return (
                <section
                  id="sedes"
                  className="relative overflow-hidden bg-[#04192e] py-[clamp(3rem,7vw,5rem)] text-white"
                  style={{ minHeight: 'min(60vh, calc(100vw * 9 / 16))' }}
                >
                    {/* Background image layer */}
                    <div
                      aria-hidden="true"
